...
type Member = { id: string; name: string; service: string | null; city: string | null; gender: string | null; postingOutlook: string | null; verified: boolean; photoMode: string; hasPhoto?: boolean; managedByFamily?: boolean };
