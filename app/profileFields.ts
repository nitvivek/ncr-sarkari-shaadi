...
export const profileSections: SectionDef[] = [
  ...
  { id: 'preferences', title: 'Partner preferences', icon: 'search', desc: 'What you’re looking for — powers your recommendations.', fields: [
    { key: 'pref_looking_for', label: 'Looking for', type: 'radio', options: ['Female', 'Male', 'Any / All Genders'], lock: true, hint: 'Set once, cannot be changed. Contact support if it is wrong.' },
